...
/**
 * @author kangqing
 * @since 2023/4/10 07:39
 */
public class EnumTicketHandlerTest {
    public static void main(String[] args) {
        ...
        // 存放实例对象
        List<EnumTicketHandler> ticketHandlers = new CopyOnWriteArrayList<>(new ArrayList<>(userNum));
        // 保存生产的车票
        ...
        for (int i = 0; i < userNum; i++) {
            Thread t = new Thread(() -> {
                // 生产懒加载单例
                EnumTicketHandler handler = EnumTicketHandler.INSTANCE;
                // 增加实例对象到list
